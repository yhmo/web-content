...
<ul>
<li><p><strong>Tokenizer</strong>: Uses the <code translate="no">standard</code><a href="/docs/zh/v2.6.x/standard-tokenizer.md"> tokenizer</a> to split text into discrete word units.</p></li>
