...
<li><a href="/docs/zh/v2.6.x/prerequisite-docker.md">Check the requirements for hardware and software</a> prior to your installation.</li>
</ul>
...
<li><strong>Woodpecker MQ</strong>: Improved message queue with reduced maintenance overhead, see <a href="/docs/zh/v2.6.x/use-woodpecker.md">Use Woodpecker</a> for detail</li>
...
<p>You can access Milvus WebUI at <code translate="no">http://127.0.0.1:9091/webui/</code> to learn more about the your Milvus instance. For details, refer to <a href="/docs/zh/v2.6.x/milvus-webui.md">Milvus WebUI</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>For applicable configuration items, refer to <a href="/docs/zh/v2.6.x/system_configuration.md">System Configuration</a>.</p>
...
<ul>
<li><p>Check <a href="/docs/zh/v2.6.x/quickstart.md">Quickstart</a> to see what Milvus can do.</p></li>
