...
<li><p>Specify the API key directly in the <code translate="no">credential</code> of the <a href="/docs/id/v2.6.x/cohere-ranker.md#Create-a-Cohere-ranker-function">ranker configuration</a></p></li>
</ul></li>
</ul>
