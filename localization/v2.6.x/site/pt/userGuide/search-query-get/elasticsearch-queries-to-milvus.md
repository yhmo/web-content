...
<table>
   ...
   <tr>
     <td><p><a href="/docs/pt/v2.6.x/elasticsearch-queries-to-milvus.md#Match-query">Match query</a></p></td>
   ...
   <tr>
     <td><p><a href="/docs/pt/v2.6.x/elasticsearch-queries-to-milvus.md#IDs">IDs</a></p></td>
   ...
   <tr>
     <td><p><a href="/docs/pt/v2.6.x/elasticsearch-queries-to-milvus.md#Prefix-query">Prefix query</a></p></td>
     <td><p><code translate="no">like</code> operator</p></td>
   </tr>
   <tr>
     <td><p><a href="/docs/pt/v2.6.x/elasticsearch-queries-to-milvus.md#Range-query">Range query</a></p></td>
   ...
   <tr>
     <td><p><a href="/docs/pt/v2.6.x/elasticsearch-queries-to-milvus.md#Term-query">Term query</a></p></td>
     <td><p>Comparison operators like <code translate="no">==</code></p></td>
   </tr>
   <tr>
     <td><p><a href="/docs/pt/v2.6.x/elasticsearch-queries-to-milvus.md#Terms-query">Terms query</a></p></td>
     <td><p><code translate="no">in</code> operator</p></td>
   </tr>
   <tr>
     <td><p><a href="/docs/pt/v2.6.x/elasticsearch-queries-to-milvus.md#Wildcard-query">Wildcard query</a></p></td>
     <td><p><code translate="no">like</code> operator</p></td>
   </tr>
   <tr>
     <td><p><a href="/docs/pt/v2.6.x/elasticsearch-queries-to-milvus.md#Boolean-query">Boolean query</a></p></td>
   ...
   <tr>
     <td><p><a href="/docs/pt/v2.6.x/elasticsearch-queries-to-milvus.md#Knn-query">kNN query</a></p></td>
     <td><p>Search</p></td>
     <td><p>Milvus provides more advanced vector search capabilities.</p></td>
   </tr>
   <tr>
     <td><p><a href="/docs/pt/v2.6.x/elasticsearch-queries-to-milvus.md#Reciprocal-rank-fusion">Reciprocal rank fusion</a></p></td>
...
<button class="copy-code-btn"></button></code></pre>
<p>You can find the Elasticsearch example on <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-prefix-query.html">this page</a>. For details on the <code translate="no">like</code> operator in Milvus, refer to <a href="/docs/pt/v2.6.x/basic-operators.md#Example-2-Using-LIKE-for-Pattern-Matching">Using </a><code translate="no">LIKE</code><a href="/docs/pt/v2.6.x/basic-operators.md#Example-2-Using-LIKE-for-Pattern-Matching"> for Pattern Matching</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>You can find the Elasticsearch example on <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-range-query.html">this page</a>. For details on comparison operators in Milvus, see <a href="/docs/pt/v2.6.x/basic-operators.md#Comparison-operators">Comparison operators</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>You can find the Elasticsearch example on <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-term-query.html">this page</a>. For details on comparison operators in Milvus, see <a href="/docs/pt/v2.6.x/basic-operators.md#Comparison-operators">Comparison operators</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>You can find the Elasticsearch example on <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-terms-query.html">this page</a>. For details on range operators in Milvus, refer to <a href="/docs/pt/v2.6.x/basic-operators.md#Range-operators">Range operators</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>You can find the Elasticsearch example on <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-wildcard-query.html">this page</a>. For details on the range operators in Milvus, refer to <a href="/docs/pt/v2.6.x/basic-operators.md#Range-operators">Range operators</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>You can find the Elasticsearch example on <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-knn-query.html">this page</a>. For details on ANN searches in Milvus, read <a href="/docs/pt/v2.6.x/single-vector-search.md">Basic ANN Search</a>.</p>
