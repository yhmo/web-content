...
<ul>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#Single-Vector-Search">Single-vector search</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#Bulk-Vector-Search">Bulk-vector search</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#ANN-Search-in-Partition">ANN search in partition</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#Use-Output-Fields">Use output fields</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#Use-Limit-and-Offset">Use limit and offset</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#Use-Level">Use level</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#Get-Recall-Rate">Get Recall Rate</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#Enhancing-ANN-Search">Enhancing ANN search</a></p></li>
</ul>
...
<p>The value of <code translate="no">timezone</code> must be a valid <a href="https://en.wikipedia.org/wiki/List_of_tz_database_time_zones">IANA time zone identifier</a> (for example, <strong>Asia/Shanghai</strong>, <strong>America/Chicago</strong>, or <strong>UTC</strong>). For details on how to use a <code translate="no">TIMESTAMPTZ</code> field, refer to <a href="/docs/pt/v2.6.x/timestamptz-field.md">TIMESTAMPTZ Field</a>.</p>
...
<p>For more about metadata filtering and filtering conditions, refer to <a href="/docs/pt/v2.6.x/filtered-search.md">Filtered Search</a>, <a href="/docs/pt/v2.6.x/boolean.md">Filtering Explained</a>, and related topics.</p></li>
<li><p>Range Search</p>
...
<p>For more about range search, refer to <a href="/docs/pt/v2.6.x/range-search.md">Range Search</a>.</p></li>
...
<p>For more about grouping search, refer to <a href="/docs/pt/v2.6.x/grouping-search.md">Grouping Search</a>,</p></li>
...
<p>For more about hybrid search, refer to <a href="/docs/pt/v2.6.x/multi-vector-search.md">Hybrid Search</a>.</p></li>
...
<p>For details on search iterators, refer to <a href="/docs/pt/v2.6.x/with-iterators.md">Search Iterator</a>.</p></li>
...
<p>For details on full-text search, refer to <a href="/docs/pt/v2.6.x/full-text-search.md">Full Text Search</a>.</p></li>
<li><p>Text Match</p>
...
<p>For details on keyword match, refer to <a href="/docs/pt/v2.6.x/keyword-match.md">Keyword Match</a>.</p></li>
...
<p>For details on the partition key, refer to <a href="/docs/pt/v2.6.x/use-partition-key.md">Use Partition Key</a>.</p></li>
<li><p>Use mmap</p>
<p>For details on mmap-settings, refer to <a href="/docs/pt/v2.6.x/mmap.md">Use mmap</a>.</p></li>
<li><p>Clustering Compaction</p>
<p>For details on clustering compactions, refer to <a href="/docs/pt/v2.6.x/clustering-compaction.md">Clustering Compaction</a>.</p></li>
<li><p>Use reranking</p>
<p>For details on using rankers to enhance search result relevance, refer to <a href="/docs/pt/v2.6.x/decay-ranker-overview.md">Decay Ranker Overview</a> and <a href="/docs/pt/v2.6.x/model-ranker-overview.md">Model Ranker Overview</a>.</p></li>
</ul>
