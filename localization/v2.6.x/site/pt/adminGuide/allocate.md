...
<ul>
<li><a href="/docs/pt/v2.6.x/allocate.md#Allocate-resources-with-commands">Use the commands</a></li>
<li><a href="/docs/pt/v2.6.x/allocate.md#Allocate-resources-by-setting-configuration-file">Set the parameters in the <code translate="no">YAML</code> file</a></li>
</ul>
...
<li><a href="/docs/pt/v2.6.x/upgrade_milvus_cluster-operator.md">Upgrade Milvus Cluster</a></li>
<li><a href="/docs/pt/v2.6.x/upgrade_milvus_standalone-operator.md">Upgrade Milvus Standalone</a></li>
</ul></li>
