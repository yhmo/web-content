...
<p>This topic is outdated and will be removed soon. You are advised to refer to <a href="/docs/es/v2.6.x/eks.md">Deploy a Milvus Cluster on EKS</a> instead.</p>
</div>
...
<ul>
<li><a href="/docs/es/v2.6.x/eks.md">Deploy a Milvus Cluster on EKS</a></li>
<li><a href="/docs/es/v2.6.x/gcp.md">Deploy Milvus Cluster on GCP with Kubernetes</a></li>
<li><a href="/docs/es/v2.6.x/azure.md">Guide to Deploying Milvus on Microsoft Azure With Kubernetes</a></li>
</ul>
