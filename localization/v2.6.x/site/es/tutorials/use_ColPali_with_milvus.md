...
<p>This page has been deprecated. For the latest example of the use of CoPali with Milvus, refer to <a href="/docs/es/v2.6.x/search-with-embedding-lists.md">Sesarch with Embedding Lists</a>.</p>
</div>
<p>
