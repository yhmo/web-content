...
<p>This integration uses the hosted Hugging Face router. To rerank with a separately deployed Text Embeddings Inference (TEI) service, see <a href="/docs/es/v2.6.x/tei-ranker.md">TEI Ranker</a>.</p>
...
<li>For shared model-ranker behavior and limits, see <a href="/docs/es/v2.6.x/model-ranker-overview.md">Model Ranker Overview</a>.</li>
<li>To generate embeddings through hosted Hugging Face Inference Providers, see <a href="/docs/es/v2.6.x/hugging-face.md">Hugging Face</a>.</li>
<li>To apply the ranker to hybrid search, see <a href="/docs/es/v2.6.x/multi-vector-search.md">Multi-Vector Hybrid Search</a>.</li>
</ul>
