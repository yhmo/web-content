...
<p>The <code translate="no">rootcoord.minSegmentSizeToEnableIndex</code> parameter determines the index-building threshold for a segment, and is set to 1024 rows by default. See <a href="/docs/es/v2.6.x/system_configuration.md">System Configuration</a> for more information.</p>
