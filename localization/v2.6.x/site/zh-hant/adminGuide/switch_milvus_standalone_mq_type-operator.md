...
<li>A running Milvus Standalone instance installed via <a href="/docs/zh-hant/v2.6.x/install_standalone-docker.md">Docker</a> or <a href="/docs/zh-hant/v2.6.x/install_standalone-docker-compose.md">Docker Compose</a>.</li>
