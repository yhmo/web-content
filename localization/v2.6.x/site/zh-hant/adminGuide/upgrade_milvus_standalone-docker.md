...
---
<div class="tab-wrapper"><a href="/docs/zh-hant/v2.6.x/upgrade_milvus_standalone-operator.md" class=''>Milvus Operator</a><a href="/docs/zh-hant/v2.6.x/upgrade_milvus_standalone-helm.md" class=''>Helm</a><a href="/docs/zh-hant/v2.6.x/upgrade_milvus_standalone-docker.md" class='active '>Docker Compose</a></div>
...
<p>This upgrade process ensures proper migration to the new architecture. For more information on architecture changes, refer to <a href="/docs/zh-hant/v2.6.x/architecture_overview.md">Milvus Architecture Overview</a>.</p>
