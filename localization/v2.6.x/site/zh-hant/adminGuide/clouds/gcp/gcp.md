...
<p>If you would like to expose your Milvus instance through a Layer-7 load balancer, <a href="/docs/zh-hant/v2.6.x/gcp_layer7.md">read this</a>.</p>
...
<ul>
<li><a href="/docs/zh-hant/v2.6.x/eks.md">Deploy Milvus Cluster on AWS with Kubernetes</a></li>
<li><a href="/docs/zh-hant/v2.6.x/azure.md">Deploy Milvus Cluster on Azure With Kubernetes</a></li>
</ul>
