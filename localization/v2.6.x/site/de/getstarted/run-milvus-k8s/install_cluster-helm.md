...
<li><p><a href="/docs/de/v2.6.x/prerequisite-helm.md#How-can-I-start-a-K8s-cluster-locally-for-test-purposes">Create a K8s cluster</a>.</p></li>
...
<li><p>Check <a href="/docs/de/v2.6.x/prerequisite-helm.md">the hardware and software requirements</a> before installation.</p></li>
...
<button class="copy-code-btn"></button></code></pre>
<p><strong>Note</strong>: Standalone mode uses Woodpecker as the default message queue and enables the Streaming Node component. For details, refer to the <a href="/docs/de/v2.6.x/architecture_overview.md">Architecture Overview</a> and <a href="/docs/de/v2.6.x/use-woodpecker.md">Use Woodpecker</a>.</p>
</div>
...
<p>For complete architecture details, refer to the <a href="/docs/de/v2.6.x/architecture_overview.md">Architecture Overview</a>.</p>
</div>
...
<p>You can also access the <strong>Milvus WebUI</strong> at <code translate="no">http://127.0.0.1:9091/webui/</code> once port forwarding is set up (see next step). For details, refer to <a href="/docs/de/v2.6.x/milvus-webui.md">Milvus WebUI</a>.</p>
...
<p>For applicable configuration items, refer to <a href="/docs/de/v2.6.x/system_configuration.md">System Configuration</a>.</p></li>
...
<ul>
<li><p>Check <a href="/docs/de/v2.6.x/quickstart.md">Hello Milvus</a> to see what Milvus can do.</p></li>
