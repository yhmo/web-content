...
<li><p><code translate="no">LIKE</code>: Used to match a pattern (mostly for text fields).  Milvus allows you to build an <code translate="no">NGRAM</code> index on VARCHAR or JSON fields to accelerate text queries. For details, refer to <a href="/docs/de/v2.6.x/ngram.md">NGRAM</a>.</p></li>
</ul>
...
<div class="alert note">
<p>An ARRAY field cannot contain partial null values as all elements in an ARRAY field must have the same data type. For details, refer to <a href="/docs/de/v2.6.x/array_data_type.md">Array Field</a>.</p>
</div>
...
If your filter condition includes a long list of match values or a complex expression with many elements, we recommend using <a href="/docs/de/v2.6.x/filtering-templating.md">Filter Templating</a> to improve query performance.</p>
