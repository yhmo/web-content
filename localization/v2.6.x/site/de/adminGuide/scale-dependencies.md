...
<p>For Milvus Operator users, refer to <a href="/docs/de/v2.6.x/object_storage_operator.md">Configure Object Storage with Milvus Operator</a>, <a href="/docs/de/v2.6.x/meta_storage_operator.md">Configure Meta Storage with Milvus Operator</a>, and <a href="/docs/de/v2.6.x/message_storage_operator.md">Configure Message Storage with Milvus Operator</a>.</p>
</div>
