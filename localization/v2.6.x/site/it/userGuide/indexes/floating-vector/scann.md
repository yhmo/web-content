...
<p>For detailed guidance on optimizing these parameters for your specific use case, refer to <a href="/docs/it/v2.6.x/scann.md#Index-params">Index params</a>.</p>
...
<p>To learn more building parameters available for the <code translate="no">SCANN</code> index, refer to <a href="/docs/it/v2.6.x/scann.md#Index-building-params">Index building params</a>.</p></li>
</ul>
...
<p>To learn more search parameters available for the <code translate="no">SCANN</code> index, refer to <a href="/docs/it/v2.6.x/scann.md#Index-specific-search-params">Index-specific search params</a>.</p></li>
</ul>
...
<h3 id="Index-building-params" class="common-anchor-header">Index building params<button data-href="#Index-building-params" class="anchor-icon" translate="no">
    ...
    </button></h3><p>The following table lists the parameters that can be configured in <code translate="no">params</code> when <a href="/docs/it/v2.6.x/scann.md#Build-index">building an index</a>.</p>
<table>
   <tr>
     <th><p>Parameter</p></th>
...
<h3 id="Index-specific-search-params" class="common-anchor-header">Index-specific search params<button data-href="#Index-specific-search-params" class="anchor-icon" translate="no">
    ...
    </button></h3><p>The following table lists the parameters that can be configured in <code translate="no">search_params.params</code> when <a href="/docs/it/v2.6.x/scann.md#Search-on-index">searching on the index</a>.</p>
<table>
   <tr>
     <th><p>Parameter</p></th>
     <th><p>Description</p></th>
