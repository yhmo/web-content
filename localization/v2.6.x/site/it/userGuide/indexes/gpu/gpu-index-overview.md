...
<li><p>GPU indexes do not support search functions like <a href="/docs/it/v2.6.x/range-search.md">range search</a> and <a href="/docs/it/v2.6.x/grouping-search.md">grouping search</a>.</p></li>
</ul>
...
<table>
   ...
   <tr>
     <td><p><a href="/docs/it/v2.6.x/gpu-cagra.md">GPU_CAGRA</a></p></td>
   ...
   <tr>
     <td><p><a href="/docs/it/v2.6.x/gpu-ivf-flat.md">GPU_IVF_FLAT</a></p></td>
   ...
   <tr>
     <td><p><a href="/docs/it/v2.6.x/gpu-ivf-pq.md">GPU_IVF_PQ</a></p></td>
   ...
   <tr>
     <td><p><a href="/docs/it/v2.6.x/gpu-brute-force.md">GPU_BRUTE_FORCE</a></p></td>
