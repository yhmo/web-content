...
<ul>
<li><a href="/docs/it/v2.6.x/visualize.md">Visualize Milvus metrics in Grafana</a></li>
<li><a href="/docs/it/v2.6.x/alert.md">Create an Alert for Milvus Services</a></li>
...
<ul>
<li>Learn <a href="/docs/it/v2.6.x/scaleout.md">scale a Milvus cluster</a></li>
</ul></li>
