...
<h3 id="Prerequisites" class="common-anchor-header">Prerequisites<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h3><p>This tutorial assumes that you have Grafana installed and configured. If not, we recommend reading the <a href="/docs/it/v2.6.x/monitor.md">monitoring guide</a>.</p>
...
<ul>
<li>Read the <a href="/docs/it/v2.6.x/monitor.md">monitoring guide</a></li>
<li>Learn how to <a href="/docs/it/v2.6.x/visualize.md">visualize monitoring metrics</a></li>
</ul></li>
<li>If you have created alerts for memory usage by Milvus components:
<ul>
<li>Learn how to <a href="/docs/it/v2.6.x/allocate.md#standalone">allocate resources</a></li>
</ul></li>
