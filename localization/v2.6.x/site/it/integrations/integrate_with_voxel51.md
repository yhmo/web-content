...
<ul>
<li>A running <a href="/docs/it/v2.6.x/install_standalone-docker.md">Milvus server</a>.</li>
...
<p>For detailed information on these parameters, see the <a href="/docs/it/v2.6.x/authenticate.md">Milvus authentication documentation</a> and <a href="/docs/it/v2.6.x/tune_consistency.md">Milvus consistency levels documentation</a>.</p>
