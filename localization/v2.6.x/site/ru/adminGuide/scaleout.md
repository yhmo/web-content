...
<p>This topic describes how to scale out and scale in a Milvus cluster. We assume that you have already <a href="/docs/ru/v2.6.x/install_cluster-helm.md">installed a Milvus cluster</a> before scaling. Also, we recommend familiarizing yourself with the <a href="/docs/ru/v2.6.x/architecture_overview.md">Milvus architecture</a> before you begin.</p>
...
<h2 id="Scale-a-Milvus-cluster" class="common-anchor-header">Scale a Milvus cluster<button data-href="#Scale-a-Milvus-cluster" class="anchor-icon" translate="no">
    ...
    </button></h2><p>You can scale in your Milvus cluster either manually or automatically. For automatic scaling with Horizontal Pod Autoscaling (HPA), see <a href="/docs/ru/v2.6.x/hpa.md">Configure HPA for Milvus</a>. If autoscaling is enabled, the Milvus cluster will shrink or expand automatically when CPU and memory resources consumption reaches the value you have set.</p>
...
<ul>
<li>Learn how to <a href="/docs/ru/v2.6.x/eks.md">Deploy Milvus on Amazon EKS with Terraform</a></li>
<li>Learn how to <a href="/docs/ru/v2.6.x/gcp.md">Deploy Milvus Cluster on GCP with Kubernetes</a></li>
<li>Learn how to <a href="/docs/ru/v2.6.x/azure.md">Deploy Milvus on Microsoft Azure With Kubernetes</a></li>
</ul></li>
