...
<h1 id="Coordinator-HA" class="common-anchor-header">Coordinator HA<button data-href="#Coordinator-HA" class="anchor-icon" translate="no">
    ...
    </button></h1><p>As shown in the <a href="/docs/ru/v2.6.x/architecture_overview.md">Milvus architecture</a>, Milvus consists of many components and has them work in a distributed manner. Among all the components, Milvus ensures the high availability of the workers through <a href="/docs/ru/v2.6.x/scaleout.md">scaling up and scaling out</a> of the nodes, making coordinators the only weak link in the chain.</p>
...
<ul>
<li><a href="/docs/ru/v2.6.x/configure_rootcoord.md#rootCoordactiveStandbyenabled">rootCoord.activeStandby.enabled</a></li>
<li><a href="/docs/ru/v2.6.x/configure_querycoord.md#queryCoordactiveStandbyenabled">queryCoord.activeStandby.enabled</a></li>
<li><a href="/docs/ru/v2.6.x/configure_datacoord.md#dataCoordactiveStandbyenabled">dataCoord.activeStandby.enabled</a></li>
</ul>
