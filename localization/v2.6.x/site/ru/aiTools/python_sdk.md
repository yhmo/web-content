...
<li><strong>Save</strong> it to the location your AI tool expects — see the <a href="/docs/ru/v2.6.x/milvus_for_agents.md">environment table</a> for placement details.</li>
