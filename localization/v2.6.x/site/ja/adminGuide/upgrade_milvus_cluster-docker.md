...
---
<div class="tab-wrapper"><a href="/docs/ja/v2.6.x/upgrade_milvus_standalone-operator.md" class=''>Milvus Operator</a><a href="/docs/ja/v2.6.x/upgrade_milvus_cluster-operator.md" class=''>Milvus Operator</a><a href="/docs/ja/v2.6.x/configure_operator.md" class=''>Milvus Operator</a><a href="/docs/ja/v2.6.x/configure-helm.md" class=''>Helm</a><a href="/docs/ja/v2.6.x/configure-docker.md" class=''>Docker Compose</a><a href="/docs/ja/v2.6.x/upgrade_milvus_standalone-helm.md" class=''>Helm</a><a href="/docs/ja/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>Docker Compose</a><a href="/docs/ja/v2.6.x/upgrade_milvus_cluster-helm.md" class=''>Helm</a></div>
