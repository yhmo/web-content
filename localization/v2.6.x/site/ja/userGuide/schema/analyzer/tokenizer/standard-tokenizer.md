...
<p>For simpler setup, you may choose to use the <a href="/docs/ja/v2.6.x/standard-analyzer.md"><code translate="no">standard</code></a> <a href="/docs/ja/v2.6.x/standard-analyzer.md">analyzer</a>, which combines the <code translate="no">standard</code> tokenizer with the <a href="/docs/ja/v2.6.x/lowercase-filter.md"><code translate="no">lowercase</code></a><a href="/docs/ja/v2.6.x/lowercase-filter.md"> filter</a>.</p>
</div>
