...
<p>For more information, refer to <a href="/docs/ja/v2.6.x/hnsw.md">HNSW</a>.</p>
...
<ul>
<li><p><strong>SQ8</strong> uses 8 bits, mapping values into 256 levels.  For more information, refer to <a href="/docs/ja/v2.6.x/ivf-sq8.md#SQ8">IVF_SQ8</a>.</p></li>
...
<p>For a full list of parameters and valid values, refer to <a href="/docs/ja/v2.6.x/hnsw-sq.md#Index-params">Index params</a>.</p>
...
<li><p><code translate="no">params</code>: Additional configuration options for building the index. For details, refer to <a href="/docs/ja/v2.6.x/hnsw-sq.md#Index-building-params">Index building params</a>.</p></li>
</ul>
...
<p>In this configuration:</p>
<ul>
<li><code translate="no">params</code>: Additional configuration options for searching on the index. For details, refer to <a href="/docs/ja/v2.6.x/hnsw-sq.md#Index-specific-search-params">Index-specific search params</a>.</li>
</ul>
...
<h3 id="Index-building-params" class="common-anchor-header">Index building params<button data-href="#Index-building-params" class="anchor-icon" translate="no">
    ...
    </button></h3><p>The following table lists the parameters that can be configured in <code translate="no">params</code> when <a href="/docs/ja/v2.6.x/hnsw-sq.md#share-PRYPd4xBJonkoZxPpNWcdnebnNh">building an index</a>.</p>
<table>
   <tr>
     <th></th>
     <th><p>Parameter</p></th>
...
<h3 id="Index-specific-search-params" class="common-anchor-header">Index-specific search params<button data-href="#Index-specific-search-params" class="anchor-icon" translate="no">
    ...
    </button></h3><p>The following table lists the parameters that can be configured in <code translate="no">search_params.params</code> when <a href="/docs/ja/v2.6.x/hnsw-sq.md#share-DeFldzMQQoc2W4x2YiIcYUbqnne">searching on the index</a>.</p>
<table>
   <tr>
     <th></th>
     <th><p>Parameter</p></th>
