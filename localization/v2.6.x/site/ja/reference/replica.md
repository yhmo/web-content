...
<p>For information on how to configure in-memory replicas, refer to <a href="/docs/ja/v2.6.x/configure_querynode.md#queryNodereplicas">Query Node-related Configurations</a>.</p>
