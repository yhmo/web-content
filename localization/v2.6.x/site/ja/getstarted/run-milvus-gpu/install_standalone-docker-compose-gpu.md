...
<li><a href="/docs/ja/v2.6.x/prerequisite-gpu.md">Check the requirements for hardware and software</a> prior to your installation.</li>
</ul>
...
<li><p>Check <a href="/docs/ja/v2.6.x/milvus-webui.md">Milvus WebUI</a> to learn more about the Milvus instance.</p></li>
