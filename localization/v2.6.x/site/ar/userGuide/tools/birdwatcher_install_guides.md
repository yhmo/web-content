...
<h2 id="Local-install" class="common-anchor-header">Local install<button data-href="#Local-install" class="anchor-icon" translate="no">
    ...
    </button></h2><p>If you have installed Milvus Standalone <a href="/docs/ar/v2.6.x/install_standalone-docker.md">using docker</a>, you’d better download and install the built binary, install Birdwatcher as a common Go module, or build Birdwatcher from the source.</p>
<ul>
...
<h2 id="Install-as-a-Kubernetes-pod" class="common-anchor-header">Install as a Kubernetes pod<button data-href="#Install-as-a-Kubernetes-pod" class="anchor-icon" translate="no">
    ...
    </button></h2><p>If you have installed either Milvus Standalone <a href="/docs/ar/v2.6.x/install_standalone-helm.md">using the Helm charts</a> or <a href="/docs/ar/v2.6.x/install_standalone-operator.md">the Milvus Operator</a> or Milvus Cluster <a href="/docs/ar/v2.6.x/install_cluster-helm.md">using the Helm charts</a> or <a href="/docs/ar/v2.6.x/install_cluster-milvusoperator.md">the Milvus Operator</a>, you are advised to install Birdwatcher as a Kubernetes pod.</p>
