...
<ul>
<li><a href="/docs/ar/v2.6.x/monitor.md">Deploy monitoring services</a></li>
<li><a href="/docs/ar/v2.6.x/visualize.md">Visualize Milvus metrics</a></li>
<li><a href="/docs/ar/v2.6.x/alert.md">Create an alert</a></li>
</ul>
