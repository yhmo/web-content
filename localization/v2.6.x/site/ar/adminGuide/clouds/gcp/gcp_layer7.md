...
<li><p>You have <a href="/docs/ar/v2.6.x/gcp.md">deployed a Milvus cluster behind a Layer-4 load balancer on GCP</a>.</p></li>
</ul>
<h3 id="Tweak-Milvus-configurations" class="common-anchor-header">Tweak Milvus configurations<button data-href="#Tweak-Milvus-configurations" class="anchor-icon" translate="no">
    ...
    </button></h3><p>This guide assumes that you have already <a href="/docs/ar/v2.6.x/gcp.md">deployed a Milvus cluster behind a Layer-4 load balancer on GCP</a>.</p>
