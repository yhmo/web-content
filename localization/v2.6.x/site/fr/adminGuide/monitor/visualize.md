...
<ul>
<li>Learn how to <a href="/docs/fr/v2.6.x/alert.md">create an alert for Milvus services</a></li>
<li>Adjust your <a href="/docs/fr/v2.6.x/allocate.md">resource allocation</a></li>
<li><a href="/docs/fr/v2.6.x/scaleout.md">Scale out or scale in a Milvus cluster</a></li>
</ul></li>
<li>If you are interested in upgrading the Milvus version,
<ul>
<li>Read the <a href="/docs/fr/v2.6.x/upgrade_milvus_cluster-operator.md">guide for upgrading Milvus cluster</a> and <a href="/docs/fr/v2.6.x/upgrade_milvus_standalone-operator.md">that for upgrade Milvus standalone</a>.</li>
</ul></li>
</ul>
