...
<ul>
<li><p>For vector fields of the <code translate="no">SPARSE\_FLOAT\_VECTOR</code> type, use the <code translate="no">BM25</code> metric type only when performing full text search. For more information, refer to <a href="/docs/fr/v2.6.x/full-text-search.md">Full Text Search</a>.</p></li>
...
<div class="alert note">
<p>To index vector fields in an <a href="/docs/fr/v2.6.x/array-of-structs.md">Array of Structs</a> field, you should prefix <code translate="no">MAX_SIM</code> to the set of metric types mentioned above, based on the vector embeddings stored in those fields. For example,</p>
<ul>
...
<p>For information on technical details, refer to <a href="/docs/fr/v2.6.x/minhash-lsh.md">MINHASH_LSH</a>.</p>
...
<h2 id="BM25-similarity" class="common-anchor-header">BM25 similarity<button data-href="#BM25-similarity" class="anchor-icon" translate="no">
    ...
    </button></h2><p>BM25 is a widely used text relevance measurement method, specifically designed for <a href="/docs/fr/v2.6.x/full-text-search.md">full text search</a>. It combines the following three key factors:</p>
<ul>
