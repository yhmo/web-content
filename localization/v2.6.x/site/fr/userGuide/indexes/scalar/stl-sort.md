...
<li><p>Numeric fields (e.g., <code translate="no">INT8</code>, <code translate="no">INT16</code>, <code translate="no">INT32</code>, <code translate="no">INT64</code>, <code translate="no">FLOAT</code>, <code translate="no">DOUBLE</code>). For details, refer to <a href="/docs/fr/v2.6.x/number.md">Boolean & Number</a>.</p></li>
<li><p><code translate="no">VARCHAR</code> fields. For details, refer to <a href="/docs/fr/v2.6.x/string.md">String Field</a>.</p></li>
<li><p><code translate="no">TIMESTAMPTZ</code> fields. For details, refer to <a href="/docs/fr/v2.6.x/timestamptz-field.md">TIMESTAMPTZ Field</a>.</p></li>
</ul>
...
<li><p><strong>Field types:</strong> Works with numeric and <code translate="no">TIMESTAMPTZ</code> fields. For more information on data types, refer to <a href="/docs/fr/v2.6.x/number.md">Boolean & Number</a> and <a href="/docs/fr/v2.6.x/timestamptz-field.md">TIMESTAMPTZ Field</a>.</p></li>
