...
<h2 id="Schema-design-guidelines" class="common-anchor-header">Schema design guidelines<button data-href="#Schema-design-guidelines" class="anchor-icon" translate="no">
    ...
    </button></h2><p>In addition to all the guidelines discussed in <a href="/docs/fr/v2.6.x/schema-hands-on.md">Data Model Design for Search</a>, you should also consider the following things before starting to use an Array of Structs in your data model design.</p>
...
<p>For details on all applicable limits, refer to <a href="/docs/fr/v2.6.x/array-of-structs.md#Limits">the limits</a>.</p>
