...
<div class="start_card_container">
  <a href="/docs/fr/v2.6.x/agents_overview.md" style="text-decoration: none; color: inherit;">
...
<div class="start_card_container">
  <a href="/docs/fr/v2.6.x/python_sdk.md" style="text-decoration: none; color: inherit;">
...
<div class="start_card_container">
  <a href="/docs/fr/v2.6.x/schema_design.md" style="text-decoration: none; color: inherit;">
...
<div class="start_card_container">
  <a href="/docs/fr/v2.6.x/search_patterns.md" style="text-decoration: none; color: inherit;">
...
<div class="start_card_container">
  <a href="/docs/fr/v2.6.x/index_selection.md" style="text-decoration: none; color: inherit;">
...
<div class="start_card_container">
  <a href="/docs/fr/v2.6.x/rag_pipeline.md" style="text-decoration: none; color: inherit;">
...
<tbody>
<tr><td>Prototyping</td><td><a href="/docs/fr/v2.6.x/milvus_lite.md">Milvus Lite</a></td><td>Zero-config, in-process. Runs anywhere Python runs — ideal for rapid agent prototyping.</td></tr>
<tr><td>Development</td><td><a href="/docs/fr/v2.6.x/install_standalone-docker.md">Milvus Standalone</a></td><td>Single-node Docker deployment. Good for local development and testing with realistic data volumes.</td></tr>
...
<tr><td>Self-hosted production</td><td><a href="/docs/fr/v2.6.x/install_cluster-helm.md">Milvus Distributed</a></td><td>Multi-node Kubernetes deployment for teams that need full control over their infrastructure.</td></tr>
</tbody>
</table>
