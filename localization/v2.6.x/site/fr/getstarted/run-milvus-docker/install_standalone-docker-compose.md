...
<button class="copy-code-btn"></button></code></pre>
<p>You can also access Milvus WebUI at <code translate="no">http://127.0.0.1:9091/webui/</code> to learn more about the your Milvus instance. For details, refer to <a href="/docs/fr/v2.6.x/milvus-webui.md">Milvus WebUI</a>.</p>
...
The following assumes that you need to override the default <code translate="no">proxy.healthCheckTimeout</code>. For applicable configuration items, refer to <a href="/docs/fr/v2.6.x/system_configuration.md">System Configuration</a>.</p>
