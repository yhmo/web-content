...
<li>Learn about the concept of <a href="/docs/fr/v2.6.x/timestamp.md">timestamp</a>.</li>
<li>Learn about the <a href="/docs/fr/v2.6.x/data_processing.md">data processing workflow</a> in Milvus.</li>
</ul>
