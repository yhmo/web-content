...
<li>Explore the <a href="/docs/fr/v2.6.x/main_components.md">Main Components</a> for detailed implementation specifics</li>
<li>Learn about <a href="/docs/fr/v2.6.x/data_processing.md">Data Processing</a> workflows and optimization strategies</li>
<li>Understand the <a href="/docs/fr/v2.6.x/tune_consistency.md">Consistency Model</a> and transaction guarantees in Milvus</li>
</ul>
