...
<p>See <a href="/docs/ko/v2.6.x/configure_pulsar.md">Pulsar-related configurations</a> for more information.</p>
...
<p>For details on how to configure Milvus using Helm, refer to <a href="/docs/ko/v2.6.x/configure-helm.md">Configure Milvus with Helm Charts</a>. For details on Pulsar-related configuration items, refer to <a href="/docs/ko/v2.6.x/configure_pulsar.md">Pulsar-related configurations</a>.
|</p>
...
<p>For details on how to configure Milvus using Helm, refer to <a href="/docs/ko/v2.6.x/configure-helm.md">Configure Milvus with Helm Charts</a>. For details on Woodpecker-related configuration items, refer to <a href="/docs/ko/v2.6.x/use-woodpecker.md">woodpecker-related configurations</a>.
|</p>
<h3 id="Using-the-YAML-file" class="common-anchor-header">Using the YAML file<button data-href="#Using-the-YAML-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
...
<p>For details on how to configure Milvus using Helm, refer to <a href="/docs/ko/v2.6.x/configure-helm.md">Configure Milvus with Helm Charts</a>. For details on Pulsar-related configuration items, refer to <a href="/docs/ko/v2.6.x/configure_pulsar.md">Pulsar-related configurations</a>.</p>
<h3 id="Using-the-YAML-file" class="common-anchor-header">Using the YAML file<button data-href="#Using-the-YAML-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
...
<h2 id="Configure-RocksMQ-with-Helm" class="common-anchor-header">Configure RocksMQ with Helm<button data-href="#Configure-RocksMQ-with-Helm" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus standalone uses RocksMQ as the default message storage. For detailed steps on how to configure Milvus with Helm, refer to <a href="/docs/ko/v2.6.x/configure-helm.md">Configure Milvus with Helm Charts</a>. For details on RocksMQ-related configuration items, refer to <a href="/docs/ko/v2.6.x/configure_rocksmq.md">RocksMQ-related configurations</a>.</p>
<ul>
...
<ul>
<li><a href="/docs/ko/v2.6.x/deploy_s3.md">Configure Object Storage with Docker Compose or Helm</a></li>
<li><a href="/docs/ko/v2.6.x/deploy_etcd.md">Configure Meta Storage with Docker Compose or Helm</a></li>
</ul>
