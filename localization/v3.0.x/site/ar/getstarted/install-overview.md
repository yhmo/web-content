...
<p>Regardless of the deployment mode, every Milvus instance relies on a message queue, object storage, and a metadata store — by default <strong>Woodpecker</strong>, <strong>MinIO</strong>, and <strong>etcd</strong>. To learn about these dependencies, tune them, or connect external services, see <a href="/docs/ar/data-infra-integration-overview.md">Data Infrastructure</a>.</p>
<p>
