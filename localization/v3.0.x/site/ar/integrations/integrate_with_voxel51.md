...
<ul>
<li>A running <a href="/docs/ar/install_standalone-docker.md">Milvus server</a>.</li>
...
<p>For detailed information on these parameters, see the <a href="/docs/ar/authenticate.md">Milvus authentication documentation</a> and <a href="/docs/ar/tune_consistency.md">Milvus consistency levels documentation</a>.</p>
