...
<p>For the StructArray basics behind this tutorial, see <a href="/docs/ar/create-structarray-field.md">Create a StructArray Field</a>, <a href="/docs/ar/index-structarray-fields.md">Index StructArray Fields</a>, and <a href="/docs/ar/basic-vector-search-with-structarray.md">Basic Vector Search with StructArray</a>. This tutorial focuses on the ColBERT and ColPali workflows rather than general StructArray syntax.</p>
...
<h3 id="Step-4-Create-a-collection-for-the-Cohere-dataset" class="common-anchor-header">Step 4: Create a collection for the Cohere dataset<button data-href="#Step-4-Create-a-collection-for-the-Cohere-dataset" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Once the data is ready, we will create a collection. In the collection, <code translate="no">paragraphs</code> is a StructArray field. For a general explanation of StructArray schemas, see <a href="/docs/ar/create-structarray-field.md">Create a StructArray Field</a>.</p>
