...
<p>For general parameters shared across all model rankers, such as <code translate="no">provider</code> and <code translate="no">queries</code>, refer to <a href="/docs/ar/model-ranker-overview.md#Create-a-model-ranker">Create a model ranker</a>.</p>
</div>
