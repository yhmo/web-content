...
<ul>
<li><a href="/docs/ar/switch-rocksmq-woodpecker.md">Switch between RocksMQ and Woodpecker</a> — Milvus Standalone (Docker Compose)</li>
<li><a href="/docs/ar/switch-pulsar-woodpecker.md">Switch between Pulsar and Woodpecker</a> — Milvus cluster (Helm / Milvus Operator)</li>
<li><a href="/docs/ar/switch-kafka-woodpecker.md">Switch between Kafka and Woodpecker</a> — Milvus cluster (Helm / Milvus Operator)</li>
</ul>
