...
<p>For detailed information on these parameters, see the <a href="/docs/ko/authenticate.md">Milvus authentication documentation</a> and <a href="/docs/ko/tune_consistency.md">Milvus consistency levels documentation</a>.</p>
