...
<p>You should include all schema-defined fields in the entities to insert. To make some of them optional, consider enabling dynamic field. For details, refer to <a href="/docs/ko/enable-dynamic-field.md">Dynamic Field</a>.</p>
<ul>
...
<p>For details on these consistency levels, refer to <a href="/docs/ko/tune_consistency.md">Consistency Level</a>.</p>
