...
<li><a href="/docs/ko/milvus_for_agents.md">Milvus for AI Agents</a></li>
</ul>
</div>
<div class="recomment-item">
  <p>Deploy</p>
...
<li><a href="/docs/ko/index-explained.md">Index Explained</a></li>
...
<ul>
<li>Added Milvus 3.0.x highlights to the <a href="/docs/ko/release_notes.md">Release Notes</a>, including External Collection, Snapshot, Storage V3, and lake ecosystem integrations.</li>
<li>Added guidance on how to <a href="/docs/ko/single-vector-search.md#Sort-Search-Results-by-Scalar-Fields--Milvus-30x">sort search results by scalar fields</a> and <a href="/docs/ko/get-and-scalar-query.md#Aggregate-Query-Results--Milvus-30x">aggregate query results</a>.</li>
<li>Added guidance on how to use <a href="/docs/ko/nullable-and-default.md">nullable vector fields</a> and <a href="/docs/ko/set-collection-ttl.md#Set-entity-level-TTL--Milvus-30x">entity-level TTL</a>.</li>
<li>Added guidance on how to use <a href="/docs/ko/minhash-function.md">MinHash Function</a> for server-side MinHash signatures.</li>
<li>Added guidance on how to <a href="/docs/ko/search-with-embedding-lists.md">search with embedding lists</a> and trigger <a href="/docs/ko/force-merge.md">force merge compaction</a>.</li>
</ul>
</div>
