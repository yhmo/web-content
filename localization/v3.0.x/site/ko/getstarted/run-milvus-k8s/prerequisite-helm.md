...
<ul>
<li><a href="/docs/ko/install_cluster-milvusoperator.md">Run Milvus in Kubernets with Milvus Operator</a></li>
<li><a href="/docs/ko/install_cluster-helm.md">Run Milvus in Kubernetes with Helm</a></li>
</ul></li>
