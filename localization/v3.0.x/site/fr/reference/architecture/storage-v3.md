...
<p>For external collection configuration and usage instructions, see <a href="/docs/fr/create-an-external-collection.md">Create an External Collection</a>.</p>
...
<li><a href="/docs/fr/text.md">Text Field</a></li>
<li><a href="/docs/fr/add-fields-to-an-existing-collection.md">Alter Collection Schema</a></li>
<li><a href="/docs/fr/create-an-external-collection.md">Create an External Collection</a></li>
<li><a href="/docs/fr/install-overview.md">Overview of Milvus Deployment Options</a></li>
<li><a href="/docs/fr/upgrade_milvus_standalone-helm.md">Upgrade Milvus Standalone with Helm Chart</a></li>
<li><a href="/docs/fr/upgrade_milvus_cluster-helm.md">Upgrade Milvus Cluster with Helm Chart</a></li>
<li><a href="/docs/fr/configure_common.md">common-related Configurations</a></li>
<li><a href="/docs/fr/configure_datacoord.md">dataCoord-related Configurations</a></li>
