...
<li><a href="/docs/fr/insert-update-delete.md">Insert, Upsert, and Delete</a></li>
...
<li><a href="/docs/fr/milvus_for_agents.md">Milvus for AI Agents</a></li>
</ul>
</div>
<div class="recomment-item">
  <p>Deploy</p>
...
<li><a href="/docs/fr/eks.md">Deploy on Clouds</a></li>
...
<li><a href="/docs/fr/index-explained.md">Index Explained</a></li>
...
<ul>
<li>Added Milvus 3.0.x highlights to the <a href="/docs/fr/release_notes.md">Release Notes</a>, including External Collection, Snapshot, Storage V3, and lake ecosystem integrations.</li>
<li>Added guidance on how to <a href="/docs/fr/single-vector-search.md#Sort-Search-Results-by-Scalar-Fields--Milvus-30x">sort search results by scalar fields</a> and <a href="/docs/fr/get-and-scalar-query.md#Aggregate-Query-Results--Milvus-30x">aggregate query results</a>.</li>
<li>Added guidance on how to use <a href="/docs/fr/nullable-and-default.md">nullable vector fields</a> and <a href="/docs/fr/set-collection-ttl.md#Set-entity-level-TTL--Milvus-30x">entity-level TTL</a>.</li>
<li>Added guidance on how to use <a href="/docs/fr/minhash-function.md">MinHash Function</a> for server-side MinHash signatures.</li>
<li>Added guidance on how to <a href="/docs/fr/search-with-embedding-lists.md">search with embedding lists</a> and trigger <a href="/docs/fr/force-merge.md">force merge compaction</a>.</li>
</ul>
</div>
