...
<li><p><a href="/docs/fr/prerequisite-helm.md#How-can-I-start-a-K8s-cluster-locally-for-test-purposes">Create a K8s cluster</a>.</p></li>
...
<li><p>Check <a href="/docs/fr/prerequisite-helm.md">the hardware and software requirements</a> before installation.</p></li>
...
<button class="copy-code-btn"></button></code></pre>
<p><strong>Note</strong>: Standalone mode uses Woodpecker as the default message queue and enables the Streaming Node component. Standalone deployments run Woodpecker <strong>embedded</strong> in the Milvus pod; the dedicated Woodpecker <strong>service</strong> (separate pods) is used for <strong>distributed/cluster</strong> deployments only. For details, refer to the <a href="/docs/fr/architecture_overview.md">Architecture Overview</a> and <a href="/docs/fr/woodpecker.md">Woodpecker</a>.</p>
</div>
...
<p>For complete architecture details, refer to the <a href="/docs/fr/architecture_overview.md">Architecture Overview</a>.</p>
</div>
...
<p>You can also access the <strong>Milvus WebUI</strong> at <code translate="no">http://127.0.0.1:9091/webui/</code> once port forwarding is set up (see next step). For details, refer to <a href="/docs/fr/milvus-webui.md">Milvus WebUI</a>.</p>
...
<p>For applicable configuration items, refer to <a href="/docs/fr/system_configuration.md">System Configuration</a>.</p></li>
...
<ul>
<li>Message queue: <a href="/docs/fr/woodpecker.md">Woodpecker</a> (default) · <a href="/docs/fr/mq_pulsar.md">Pulsar</a> · <a href="/docs/fr/mq_kafka.md">Kafka</a> · <a href="/docs/fr/mq_rocksmq.md">RocksMQ</a></li>
<li>Object storage: <a href="/docs/fr/deploy_s3.md">MinIO</a> (default) · <a href="/docs/fr/deploy_s3.md">AWS S3</a> · <a href="/docs/fr/abs.md">Azure Blob</a> · <a href="/docs/fr/gcs.md">GCP Cloud Storage</a> · <a href="/docs/fr/deploy_s3.md">Aliyun OSS</a> · <a href="/docs/fr/deploy_s3.md">Tencent COS</a> · <a href="/docs/fr/deploy_s3.md">Huawei OBS</a> · <a href="/docs/fr/deploy_s3.md">S3-compatible</a></li>
<li>Metadata: <a href="/docs/fr/deploy_etcd.md">etcd</a></li>
</ul>
<div class="alert note">
<p>Storage V3 is disabled by default. Enable it before using features that depend on it. For requirements and compatibility considerations, see <a href="/docs/fr/storage-v3.md">Storage V3</a>.</p>
</div>
...
<ul>
<li><p>Check <a href="/docs/fr/quickstart.md">Hello Milvus</a> to see what Milvus can do.</p></li>
...
<li><p>Explore <a href="/docs/fr/milvus-webui.md">Milvus WebUI</a>, an intuitive web interface for Milvus observability and management.</p></li>
