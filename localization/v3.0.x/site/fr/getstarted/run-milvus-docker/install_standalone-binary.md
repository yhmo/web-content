...
<p>By default, Milvus Standalone runs <strong>Woodpecker</strong> (local filesystem) as its message queue with embedded etcd, so no external messaging or metadata service is required. See <a href="/docs/fr/woodpecker.md">Woodpecker</a>.</p>
</div>
