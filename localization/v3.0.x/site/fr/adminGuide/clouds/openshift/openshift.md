...
<ul>
<li><a href="/docs/fr/eks.md">Deploy Milvus Cluster on AWS with Kubernetes</a></li>
<li><a href="/docs/fr/azure.md">Deploy Milvus Cluster on Azure with Kubernetes</a></li>
