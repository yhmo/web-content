...
<table>
   ...
   <tr>
     <td><p><a href="/docs/fr/stop-filter.md">Stop filter</a></p></td>
     <td><p><code translate="no">stop_words_file</code></p></td>
   </tr>
   <tr>
     <td><p><a href="/docs/fr/decompounder-filter.md">Decompounder filter</a></p></td>
     <td><p><code translate="no">word_list_file</code></p></td>
   </tr>
   <tr>
     <td><p><a href="/docs/fr/synonym-filter.md">Synonym filter</a></p></td>
