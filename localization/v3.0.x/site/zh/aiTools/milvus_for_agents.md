...
<tbody>
<tr><td>Prototyping</td><td><a href="/docs/zh/milvus_lite.md">Milvus Lite</a></td><td>Zero-config, in-process. Runs anywhere Python runs — ideal for rapid agent prototyping.</td></tr>
<tr><td>Development</td><td><a href="/docs/zh/install_standalone-docker.md">Milvus Standalone</a></td><td>Single-node Docker deployment. Good for local development and testing with realistic data volumes.</td></tr>
...
<tr><td>Self-hosted production</td><td><a href="/docs/zh/install_cluster-helm.md">Milvus Distributed</a></td><td>Multi-node Kubernetes deployment for teams that need full control over their infrastructure.</td></tr>
</tbody>
</table>
