...
<button class="copy-code-btn"></button></code></pre>
<p>The <code translate="no">cncharonly</code> filter operates on the terms generated by the tokenizer, so it must be used in combination with a tokenizer. For a list of tokenizers available in Milvus, refer to <a href="/docs/zh/jieba-tokenizer.md">Jieba</a> and its sibling pages.</p>
