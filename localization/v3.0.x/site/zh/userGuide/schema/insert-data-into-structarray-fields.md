...
<p>This page uses the <code translate="no">tech_articles</code> collection from <a href="/docs/zh/create-structarray-field.md">Create a StructArray Field</a>. Each entity is a technical article, and the <code translate="no">chunks</code> field stores article chunks as Struct elements.</p>
...
<li><p>To create indexes for <code translate="no">chunks[emb_list_vector]</code>, <code translate="no">chunks[emb]</code>, and scalar subfields, read <a href="/docs/zh/index-structarray-fields.md">Index StructArray Fields</a>.</p></li>
...
<li><p>To review nullable behavior and version-specific limitations, read <a href="/docs/zh/structarray-limits.md">StructArray Limits</a>.</p></li>
</ol>
