...
<p>This integration uses the hosted Hugging Face router. To connect Milvus to a separately deployed Text Embeddings Inference (TEI) service, see <a href="/docs/ru/hugging-face-tei.md">Hugging Face TEI</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>For details on applying Docker Compose settings, see <a href="/docs/ru/configure-docker.md">Configure Milvus with Docker Compose</a>.</p>
...
<li>For general Function concepts and insert/search behavior, see <a href="/docs/ru/embedding-function-overview.md">Embedding Function Overview</a>.</li>
<li>To rerank vector-search candidates with hosted Hugging Face sentence-similarity scores, see <a href="/docs/ru/hugging-face-ranker.md">Hugging Face Ranker</a>.</li>
</ul>
