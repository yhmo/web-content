...
<li><p>To add scalar filters to hybrid search, read <a href="/docs/ru/filtered-search-with-structarray.md">Filtered Search with StructArray</a>.</p></li>
<li><p>To use score or distance boundaries in hybrid search, read <a href="/docs/ru/range-search-with-structarray.md">Range Search with StructArray</a>.</p></li>
<li><p>To group element-level hybrid results by parent entity, read <a href="/docs/ru/grouping-search-with-structarray.md">Grouping Search with StructArray</a>.</p></li>
