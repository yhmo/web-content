...
<ul>
<li><p>If you are unsure which mode to choose, <a href="/docs/ru/primary-field.md#Quickstart-Use-AutoID">start with AutoID</a> for simpler ingestion and guaranteed uniqueness.</p></li>
...
<p>For configuration details, refer to <a href="/docs/ru/modify-collection.md#Example-5-Enable-allowinsertautoid">Modify Collection</a>.</p>
...
<h2 id="Reference-How-AutoID-works" class="common-anchor-header">Reference: How AutoID works<button data-href="#Reference-How-AutoID-works" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Understanding how AutoID generates unique identifiers internally can help you <a href="/docs/ru/primary-field.md#Ensure-global-AutoID-uniqueness-across-clusters">configure cluster IDs</a> correctly and troubleshoot ID-related issues.</p>
