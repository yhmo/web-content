...
<p>For version-specific support, nullable behavior, and other limits, see <a href="/docs/ru/structarray-limits.md">StructArray Limits</a>.</p>
...
<li><p>To insert nested data into the StructArray field, read <a href="/docs/ru/insert-data-into-structarray-fields.md">Insert Data into StructArray Fields</a>.</p></li>
<li><p>To create vector and scalar indexes, read <a href="/docs/ru/index-structarray-fields.md">Index StructArray Fields</a>.</p></li>
<li><p>To search StructArray vector subfields, read <a href="/docs/ru/basic-vector-search-with-structarray.md">Basic Vector Search with StructArray</a>.</p></li>
<li><p>To review supported data types, nullable behavior, and version-specific limitations, read <a href="/docs/ru/structarray-limits.md">StructArray Limits</a>.</p></li>
</ol>
