...
<p>For details on <code translate="no">LIKE</code> and regex filter expression syntax, refer to <a href="/docs/ru/pattern-matching.md">Pattern Matching</a>.</p>
</div>
...
<p>For more information on how to index a JSON field, refer to <a href="/docs/ru/json-indexing.md">JSON Indexing</a>.</p>
...
<p>For more information on filter expression syntax, refer to <a href="/docs/ru/pattern-matching.md">Pattern Matching</a>.</p>
