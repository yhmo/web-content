...
<h1 id="AISAQ" class="common-anchor-header">AISAQ<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.6.4+</span><button data-href="#AISAQ" class="anchor-icon" translate="no">
    ...
    </button></h1><p>AISAQ is a disk-based vector index that extends <a href="/docs/ru/diskann.md">DISKANN</a> to handle billion-scale datasets with a minimal DRAM footprint.</p>
...
<p>For a detailed explanation of these components and parameters, refer to <a href="/docs/ru/diskann.md">DISKANN</a>.</p>
