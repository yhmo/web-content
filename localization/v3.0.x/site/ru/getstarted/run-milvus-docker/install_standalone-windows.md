...
<p>By default, this deployment runs <strong>Woodpecker</strong> (local filesystem) as its message queue, so no external message-queue service is required. See <a href="/docs/ru/woodpecker.md">Woodpecker</a>.</p>
</blockquote>
