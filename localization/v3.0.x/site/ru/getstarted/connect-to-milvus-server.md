...
<li><p>The SDK of your language installed. For details, refer to <a href="/docs/ru/install-pymilvus.md">Python SDK</a>, <a href="/docs/ru/install-java.md">Java SDK</a>, <a href="/docs/ru/install-go.md">Go SDK</a>, or <a href="/docs/ru/install-node.md">Nodejs SDK</a>.</p></li>
...
<p>Token format is <code translate="no">&quot;&lt;username&gt;:&lt;password&gt;&quot;</code>. The docs explicitly note <code translate="no">root:Milvus</code> as the default credential, and the <a href="/docs/ru/users_and_roles.md">Create Users & Roles</a> guide covers managing users.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p>See the <a href="/docs/ru/manage_databases.md">Database</a> guide for creating, listing, and describing databases, and for broader database management tasks.</p>
</div>
...
<li><p><a href="/docs/ru/insert-update-delete.md">Insert Entities</a></p></li>
<li><p><a href="/docs/ru/single-vector-search.md">Basic Vector Search</a></p></li>
</ul>
