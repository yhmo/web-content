...
<li><a href="/docs/ru/prerequisite-gpu.md">Check the requirements for hardware and software</a> prior to your installation.</li>
</ul>
...
<li><p>Check <a href="/docs/ru/milvus-webui.md">Milvus WebUI</a> to learn more about the Milvus instance.</p></li>
