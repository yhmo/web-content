...
<li>Learn about the concept of <a href="/docs/ru/timestamp.md">timestamp</a>.</li>
<li>Learn about the <a href="/docs/ru/data_processing.md">data processing workflow</a> in Milvus.</li>
</ul>
