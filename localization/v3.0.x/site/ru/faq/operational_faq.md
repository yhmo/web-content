...
<p>For Milvus standalone, you should be able to observe at least three running Docker containers, one being the Milvus service and the other two being etcd management and storage service. For more information, see <a href="/docs/ru/install_standalone-docker.md">Installing Milvus Standalone</a>.</p>
...
<p>See <a href="/docs/ru/prerequisite-docker.md">CPU’s support for SIMD Instruction Set</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h4 id="Can-I-deploy-Milvus-when-disconnected-from-the-Internet" class="common-anchor-header">Can I deploy Milvus when disconnected from the Internet?</h4><p>Yes. You can install Milvus in an offline environment. See <a href="/docs/ru/install_offline-helm.md">Install Milvus Offline</a> for more information.</p>
