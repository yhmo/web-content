...
---
<div class="tab-wrapper"><a href="/docs/ru/upgrade_milvus_cluster-operator.md" class=''>Milvus Operator</a><a href="/docs/ru/upgrade_milvus_cluster-helm.md" class='active '>Helm</a></div>
...
<div class="alert note">
<p>Upgrading to Milvus 3.0 does not enable Storage V3. After you verify the upgrade, review <a href="/docs/ru/storage-v3.md">Storage V3</a> before enabling features that depend on it. Once Milvus writes Storage V3 data, downgrading to an older Milvus version that cannot read Storage V3 is not supported.</p>
</div>
