...
<p>Since Milvus 2.5, the Milvus Helm chart and Milvus Operator deploy <strong>Pulsar v3</strong> by default; Pulsar v2 remains compatible. See <a href="/docs/ru/upgrade-pulsar-v3.md">Upgrade Pulsar from v2 to v3</a> and <a href="/docs/ru/use-pulsar-v2.md">Continue Using Pulsar v2</a>.</p>
...
<li><strong>Pulsar v2 → v3:</strong> see <a href="/docs/ru/upgrade-pulsar-v3.md">Upgrade Pulsar from v2 to v3</a>; to stay on v2, see <a href="/docs/ru/use-pulsar-v2.md">Continue Using Pulsar v2</a>.</li>
</ul>
...
<li><a href="/docs/ru/switch-pulsar-woodpecker.md">Switch between Pulsar and Woodpecker</a></li>
</ul>
