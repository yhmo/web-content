...
<p>This topic assumes that you have deployed Milvus Operator. See <a href="/docs/ru/install_cluster-milvusoperator.md">Deploy Milvus Operator</a> for more information.</p>
  ...
  <tr>
    <td>
        <ul>
            ...
            <li><a href="/docs/ru/configure_minio.md">MinIO or S3</a></li>
    ...
    <td>
        <ul>
            <li><a href="/docs/ru/configure_rootcoord.md">Root coord</a></li>
            <li><a href="/docs/ru/configure_proxy.md">Proxy</a></li>
            <li><a href="/docs/ru/configure_querycoord.md">Query coord</a></li>
            <li><a href="/docs/ru/configure_querynode.md">Query node</a></li>
            <li><a href="/docs/ru/configure_indexnode.md">Index node</a></li>
            <li><a href="/docs/ru/configure_datacoord.md">Data coord</a></li>
            <li><a href="/docs/ru/configure_datanode.md">Data node</a></li>
            <li><a href="/docs/ru/configure_localstorage.md">Local storage</a></li>
            <li><a href="/docs/ru/configure_log.md">Log</a></li>
            <li><a href="/docs/ru/configure_msgchannel.md">Message channel</a></li>
            <li><a href="/docs/ru/configure_common.md">Common</a></li>
            <li><a href="/docs/ru/configure_gpu.md">GPU</a></li>
            <li><a href="/docs/ru/configure_grpc.md">GRPC</a></li>
            <li><a href="/docs/ru/configure_indexcoord.md">Index coord</a></li>
            <li><a href="/docs/ru/configure_metastore.md">Metastore</a></li>
            <li><a href="/docs/ru/configure_mq.md">Message Queue</a></li>
            <li><a href="/docs/ru/configure_tikv.md">Tikv</a></li>
            <li><a href="/docs/ru/configure_trace.md">Trace</a></li>
            <li><a href="/docs/ru/configure_quotaandlimits.md">Quota and Limits</a></li>
        </ul>
    </td>
  </tr>
</tbody>
...
<ul>
<li><a href="/docs/ru/object_storage_operator.md">Configure Object Storage with Milvus Operator</a></li>
<li><a href="/docs/ru/meta_storage_operator.md">Configure Meta Storage with Milvus Operator</a></li>
<li><a href="/docs/ru/message_storage_operator.md">Configure Message Storage with Milvus Operator</a></li>
</ul></li>
</ul>
