...
<p>For more information, refer to <a href="/docs/de/create-an-external-collection.md">Create an External Collection</a> and <a href="/docs/de/snapshots.md">Snapshots</a>.</p>
...
<p>For more information, refer to <a href="/docs/de/array-of-structs.md">StructArray</a> and <a href="/docs/de/struct-array-operators.md">StructArray Operators</a>.</p>
...
<p>For more information, refer to <a href="/docs/de/create-an-external-collection.md">Create an External Collection</a>.</p>
...
<p>For more information, refer to <a href="/docs/de/snapshots.md">Snapshots</a>, <a href="/docs/de/manage-snapshots.md">Manage Snapshots</a>, and <a href="/docs/de/snapshot-use-cases.md">Snapshot Use Cases</a>.</p>
...
<p>For more information, refer to <a href="/docs/de/single-vector-search.md#Sort-Search-Results-by-Scalar-Fields--Milvus-30x">Sort Search Results by Scalar Fields</a> and <a href="/docs/de/get-and-scalar-query.md#Sort-Query-Results--Milvus-30x">Sort Query Results</a>.</p>
...
<p>For more information, refer to <a href="/docs/de/get-and-scalar-query.md#Aggregate-Query-Results--Milvus-30x">Aggregate Query Results</a>.</p>
...
<p>For more information, refer to <a href="/docs/de/nullable-and-default.md">Nullable Fields</a>.</p>
...
<p>For more information, refer to <a href="/docs/de/manage-file-resources.md">Manage File Resources</a>.</p>
...
<p>For more information, refer to <a href="/docs/de/set-collection-ttl.md#Set-entity-level-TTL--Milvus-30x">Set Entity-level TTL</a>.</p>
...
<p>For more information, refer to <a href="/docs/de/minhash-function.md">MinHash Function</a>.</p>
...
<p>For more information, refer to <a href="/docs/de/search-with-embedding-lists.md">Search with Embedding Lists</a>.</p>
...
<p>For more information, refer to <a href="/docs/de/force-merge.md">Force Merge Compaction</a>.</p>
