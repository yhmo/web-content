...
<table>
   ...
   <tr>
     ...
     <td><p>A reference to a <a href="/docs/de/manage-file-resources.md">file resource</a> that stores synonym rules, one per line. Use for larger dictionaries. See <a href="/docs/de/synonym-filter.md#External-dictionary-file">External dictionary file</a> below.</p></td>
     <td><p>—</p></td>
   </tr>
   <tr>
