...
<button class="copy-code-btn"></button></code></pre>
<p>The <code translate="no">cnalphanumonly</code> filter operates on the terms generated by the tokenizer, so it must be used in combination with a tokenizer. For a list of tokenizers available in Milvus, refer to <a href="/docs/de/jieba-tokenizer.md">Jieba</a> and its sibling pages.</p>
