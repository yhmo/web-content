...
<p>To learn more building parameters available for the <code translate="no">IVF_SQ8</code> index, refer to <a href="/docs/de/ivf-sq8.md#share-BwprdWFCjoMBtMxorO0cWrUPnjb">Index building params</a>.</p></li>
</ul>
...
<p>To learn more search parameters available for the <code translate="no">IVF_SQ8</code> index, refer to <a href="/docs/de/ivf-sq8.md#share-PJhqdqNaNodKiexm6F1cD2IInbe">Index-specific search params</a>.</p></li>
</ul>
...
<h3 id="Index-building-params" class="common-anchor-header">Index building params<button data-href="#Index-building-params" class="anchor-icon" translate="no">
    ...
    </button></h3><p>The following table lists the parameters that can be configured in <code translate="no">params</code> when <a href="/docs/de/ivf-sq8.md#share-X9Y9dTuhDohRRBxSvzBcXmIEnu4">building an index</a>.</p>
<table>
   <tr>
     <th></th>
     <th><p>Parameter</p></th>
...
<h3 id="Index-specific-search-params" class="common-anchor-header">Index-specific search params<button data-href="#Index-specific-search-params" class="anchor-icon" translate="no">
    ...
    </button></h3><p>The following table lists the parameters that can be configured in <code translate="no">search_params.params</code> when <a href="/docs/de/ivf-sq8.md#share-TI73dmWBOoEnocxQ8H7clSYUnLg">searching on the index</a>.</p>
<table>
   <tr>
     <th></th>
     <th><p>Parameter</p></th>
