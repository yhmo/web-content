...
<li><p>GPU indexes do not support search functions like <a href="/docs/de/range-search.md">range search</a> and <a href="/docs/de/grouping-search.md">grouping search</a>.</p></li>
</ul>
