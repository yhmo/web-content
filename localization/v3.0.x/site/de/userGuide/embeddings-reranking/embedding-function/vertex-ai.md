...
<div class="alert note">
<p>To obtain your Milvus configuration file (<strong>docker-compose.yaml</strong>), refer to <a href="/docs/de/configure-docker.md#Download-an-installation-file">Download an installation file</a>.</p>
</div>
<ol>
...
<div class="alert note">
<p>To obtain your Milvus configuration file (<strong>values.yaml</strong>), refer to <a href="/docs/de/configure-helm.md#Configure-Milvus-via-configuration-file">Configure Milvus via configuration file</a>.</p>
</div>
<ol>
...
<h2 id="Next-steps" class="common-anchor-header">Next steps<button data-href="#Next-steps" class="anchor-icon" translate="no">
    ...
    </button></h2><p>After configuring the embedding function, refer to the <a href="/docs/de/embeddings.md">Function Overview</a> for additional guidance on index configuration, data insertion examples, and semantic search operations.</p>
