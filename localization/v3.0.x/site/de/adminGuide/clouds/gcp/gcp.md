...
<ul>
<li><a href="/docs/de/eks.md">Deploy Milvus Cluster on AWS with Kubernetes</a></li>
<li><a href="/docs/de/azure.md">Deploy Milvus Cluster on Azure With Kubernetes</a></li>
</ul>
