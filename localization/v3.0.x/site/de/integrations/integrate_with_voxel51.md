...
<p>For detailed information on these parameters, see the <a href="/docs/de/authenticate.md">Milvus authentication documentation</a> and <a href="/docs/de/tune_consistency.md">Milvus consistency levels documentation</a>.</p>
