...
<ul>
<li>A running <a href="/docs/id/install_standalone-docker.md">Milvus server</a>.</li>
...
<p>For detailed information on these parameters, see the <a href="/docs/id/authenticate.md">Milvus authentication documentation</a> and <a href="/docs/id/tune_consistency.md">Milvus consistency levels documentation</a>.</p>
