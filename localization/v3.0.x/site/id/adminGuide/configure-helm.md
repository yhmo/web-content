...
<ul>
<li>Learn <a href="/docs/id/monitor.md">Monitor Milvus with Prometheus Operator on Kubernetes</a></li>
<li>Learn <a href="/docs/id/visualize.md">Visualize Milvus Metrics in Grafana</a>.</li>
</ul></li>
<li><p>If you are looking for instructions on how to allocate resources:</p>
<ul>
<li><a href="/docs/id/allocate.md#standalone">Allocate Resources on Kubernetes</a></li>
</ul></li>
</ul>
