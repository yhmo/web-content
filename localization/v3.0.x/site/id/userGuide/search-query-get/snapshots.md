...
<p>To create backups, refer to <a href="/docs/id/milvus_backup_overview.md">Milvus Backup</a>.</p>
...
<li><a href="/docs/id/manage-snapshots.md">Manage Snapshots</a> — create, list, describe, pin, restore, and delete snapshots.</li>
<li><a href="/docs/id/snapshot-use-cases.md">Snapshot Use Cases</a> — common patterns and workflows.</li>
<li><a href="/docs/id/milvus_backup_overview.md">Milvus Backup</a> — long-term backup and restore across clusters.</li>
</ul>
