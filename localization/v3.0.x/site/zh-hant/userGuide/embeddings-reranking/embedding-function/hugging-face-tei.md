...
<p>After deployment, make note of your TEI service endpoint (e.g., <code translate="no">http://localhost:8080</code>) as you’ll need it when <a href="/docs/zh-hant/hugging-face-tei.md#Use-embedding-function-">using the TEI function in Milvus</a>.</p>
