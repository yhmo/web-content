...
<h1 id="Index-with-GPU" class="common-anchor-header">Index with GPU<button data-href="#Index-with-GPU" class="anchor-icon" translate="no">
    ...
    </button></h1><p>This guide outlines the steps to build an index with GPU support in Milvus, which can significantly improve search performance in high-throughput and high-recall scenarios. For details on the types of GPU indexes supported by Milvus, refer to <a href="/docs/zh-hant/gpu_index.md">GPU Index</a>.</p>
<div class="alert warning">
<p>This page has been deprecated. For the latest implementation, refer to <a href="/docs/zh-hant/gpu-index-overview.md">GPU Index Overview</a></p>
</div>
