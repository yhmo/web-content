...
<ul>
<li>A running <a href="/docs/zh-hant/install_standalone-docker.md">Milvus server</a>.</li>
...
<p>For detailed information on these parameters, see the <a href="/docs/zh-hant/authenticate.md">Milvus authentication documentation</a> and <a href="/docs/zh-hant/tune_consistency.md">Milvus consistency levels documentation</a>.</p>
