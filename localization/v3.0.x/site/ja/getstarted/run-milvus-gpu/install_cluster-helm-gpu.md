...
<li><p><a href="/docs/ja/prerequisite-gpu.md#How-can-I-start-a-K8s-cluster-with-GPU-worker-nodes">Create a K8s cluster with GPU worker nodes</a>.</p></li>
...
<li><p>Check <a href="/docs/ja/prerequisite-gpu.md">the hardware and software requirements</a> before installation.</p></li>
</ul>
