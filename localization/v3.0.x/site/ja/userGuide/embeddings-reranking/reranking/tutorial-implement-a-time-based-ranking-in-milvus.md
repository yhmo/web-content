...
<p>Each ranker has different characteristics that make them suitable for various use cases. For more information, refer to <a href="/docs/ja/decay-ranker-overview.md">Decay Ranker Overview</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>For details on how to use Milvus embedding functions, refer to <a href="/docs/ja/embedding-function-overview.md">Embedding Function Overview</a>.</p>
