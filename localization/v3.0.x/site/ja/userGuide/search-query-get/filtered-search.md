...
<p>If the query vectors already exist in the target collection, consider using <code translate="no">ids</code> instead of retrieving them before searches. For details, refer to <a href="/docs/ja/primary-key-search.md">Primary-Key Search</a>.</p>
</div>
...
<span class="hljs-punctuation">]</span>
<button class="copy-code-btn"></button></code></pre>
<p>For more information on the operators you can use in metadata filtering, refer to <a href="/docs/ja/filtering">Filtering</a>.</p>
