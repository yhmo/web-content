...
<p>For more information, refer to <a href="/docs/pt/create-an-external-collection.md">Create an External Collection</a> and <a href="/docs/pt/snapshots.md">Snapshots</a>.</p>
...
<p>For more information, refer to <a href="/docs/pt/array-of-structs.md">StructArray</a> and <a href="/docs/pt/struct-array-operators.md">StructArray Operators</a>.</p>
...
<p>For more information, refer to <a href="/docs/pt/create-an-external-collection.md">Create an External Collection</a>.</p>
...
<p>For more information, refer to <a href="/docs/pt/snapshots.md">Snapshots</a>, <a href="/docs/pt/manage-snapshots.md">Manage Snapshots</a>, and <a href="/docs/pt/snapshot-use-cases.md">Snapshot Use Cases</a>.</p>
...
<p>For more information, refer to <a href="/docs/pt/single-vector-search.md#Sort-Search-Results-by-Scalar-Fields--Milvus-30x">Sort Search Results by Scalar Fields</a> and <a href="/docs/pt/get-and-scalar-query.md#Sort-Query-Results--Milvus-30x">Sort Query Results</a>.</p>
...
<p>For more information, refer to <a href="/docs/pt/get-and-scalar-query.md#Aggregate-Query-Results--Milvus-30x">Aggregate Query Results</a>.</p>
...
<p>For more information, refer to <a href="/docs/pt/nullable-and-default.md">Nullable Fields</a>.</p>
...
<p>For more information, refer to <a href="/docs/pt/manage-file-resources.md">Manage File Resources</a>.</p>
...
<p>For more information, refer to <a href="/docs/pt/set-collection-ttl.md#Set-entity-level-TTL--Milvus-30x">Set Entity-level TTL</a>.</p>
...
<p>For more information, refer to <a href="/docs/pt/minhash-function.md">MinHash Function</a>.</p>
...
<p>For more information, refer to <a href="/docs/pt/search-with-embedding-lists.md">Search with Embedding Lists</a>.</p>
...
<p>For more information, refer to <a href="/docs/pt/force-merge.md">Force Merge Compaction</a>.</p>
