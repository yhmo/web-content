...
<p>For more on metadata filtering, refer to <a href="/docs/pt/basic-operators.md">Boolean Expression Rules</a>.</p>
...
<div class="alert note">
<p>For detailed usage, advanced examples, and best practices, refer to <a href="/docs/pt/random-sampling.md">Random Sampling</a>.</p>
</div>
<div class="multipleCode">
    <a href="#python">Python</a>
    <a href="#java">Java</a>
