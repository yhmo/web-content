...
<p>Before you begin, make sure CDC replication is already configured between your clusters. For details, refer to <a href="/docs/pt/set_up_cdc_replication.md">Set Up CDC Replication</a>.</p>
