...
<ul>
<li><a href="/docs/pt/eks.md">Deploy Milvus Cluster on AWS with Kubernetes</a></li>
<li><a href="/docs/pt/azure.md">Deploy Milvus Cluster on Azure With Kubernetes</a></li>
</ul>
