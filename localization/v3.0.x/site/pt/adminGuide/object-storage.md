...
<p>For configuration details, see <a href="/docs/pt/deploy_s3.md">Configure Object Storage with Docker Compose or Helm</a> and <a href="/docs/pt/object_storage_operator.md">Configure Object Storage with Milvus Operator</a>.</p>
...
<p>See the object storage compatibility matrix on the <a href="/docs/pt/woodpecker.md">Woodpecker</a> page for the exact per-provider requirements.</p>
