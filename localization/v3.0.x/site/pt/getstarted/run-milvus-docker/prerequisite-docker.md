...
<ul>
<li><a href="/docs/pt/install_standalone-docker.md">Run Milvus in Docker</a></li>
<li><a href="/docs/pt/install_standalone-docker-compose.md">Run Milvus with Docker Compose</a></li>
</ul>
