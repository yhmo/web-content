...
<ul>
<li><strong>Message Queue</strong>: <a href="/docs/pt/woodpecker.md">Uses Woodpecker</a> (reduces infrastructure maintenance)</li>
...
<ul>
<li>Message queue: <a href="/docs/pt/woodpecker.md">Woodpecker</a> (default) · <a href="/docs/pt/message_storage_operator.md#Configure-Pulsar">Pulsar</a> · <a href="/docs/pt/message_storage_operator.md#Configure-Kafka">Kafka</a> · <a href="/docs/pt/message_storage_operator.md#Configure-RocksMQ">RocksMQ</a></li>
<li>Object storage: <a href="/docs/pt/object_storage_operator.md">Configure object storage with Milvus Operator</a></li>
<li>Metadata: <a href="/docs/pt/meta_storage_operator.md">Configure etcd with Milvus Operator</a></li>
</ul>
<div class="alert note">
