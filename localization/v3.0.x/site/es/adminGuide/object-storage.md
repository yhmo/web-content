...
<p>For configuration details, see <a href="/docs/es/deploy_s3.md">Configure Object Storage with Docker Compose or Helm</a> and <a href="/docs/es/object_storage_operator.md">Configure Object Storage with Milvus Operator</a>.</p>
...
<p>See the object storage compatibility matrix on the <a href="/docs/es/woodpecker.md">Woodpecker</a> page for the exact per-provider requirements.</p>
