...
<table>
   ...
   <tr>
     <td><p><a href="/docs/es/jieba-tokenizer.md">Jieba tokenizer</a></p></td>
     <td><p><code translate="no">extra_dict_file</code></p></td>
   </tr>
   <tr>
     <td><p><a href="/docs/es/stop-filter.md">Stop filter</a></p></td>
     <td><p><code translate="no">stop_words_file</code></p></td>
   </tr>
   <tr>
     <td><p><a href="/docs/es/decompounder-filter.md">Decompounder filter</a></p></td>
     <td><p><code translate="no">word_list_file</code></p></td>
   </tr>
   <tr>
     <td><p><a href="/docs/es/synonym-filter.md">Synonym filter</a></p></td>
