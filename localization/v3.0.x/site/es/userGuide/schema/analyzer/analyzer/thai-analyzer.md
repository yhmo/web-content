...
<ul>
<li><strong>Tokenization</strong>: Uses the <a href="/docs/es/thai-tokenizer.md"><code translate="no">thai</code></a> tokenizer to segment Thai text into word tokens without relying on whitespace. The tokenizer filters out whitespace and punctuation-only segments.</li>
