...
<p>You can also enable the dynamic field feature to store undeclared fields flexibly, but it’s not required for JSON fields to function. For more information, refer to <a href="/docs/es/enable-dynamic-field.md">Dynamic Field</a>.</p>
</div>
...
<ul>
<li><p>This type must match the actual data type of the field being indexed. If you want to convert the data type to another during indexing, consider <a href="/docs/es/use-json-fields.md#Use-JSON-cast-functions-for-type-conversion">using a cast function</a>.</p></li>
<li><p>For a complete list, see <a href="/docs/es/use-json-fields.md#Supported-JSON-cast-types">below</a>.</p></li>
</ul></li>
</ul>
...
<div class="alert note">
<p>Arrays should contain elements of the same type for optimal indexing. For more information, refer to <a href="/docs/es/array_data_type.md">Array Field</a>.</p>
</div>
...
<p>For a full list of supported operators and expressions, refer to <a href="/docs/es/json-operators.md">JSON Operators</a>.</p>
...
<p>Refer to <a href="/docs/es/create-collection.md#Optional-Set-Index-Parameters">Set Index Parameters</a></p></li>
<li><p><strong>Load the collection</strong></p>
<p>Refer to <a href="/docs/es/load-and-release.md">Load & Release</a></p></li>
<li><p><strong>Search or query using JSON path filters</strong></p>
<p>Refer to <a href="/docs/es/filtered-search.md">Filtered Search</a> and <a href="/docs/es/json-operators.md">JSON Operators</a></p></li>
</ul>
...
<p>Refer to <a href="/docs/es/enable-dynamic-field.md">Dynamic Field</a> for details.</p>
...
<p>Refer to <a href="/docs/es/nullable-and-default.md">Nullable & Default</a> for details.</p>
