...
<li><p>GPU indexes do not support search functions like <a href="/docs/es/range-search.md">range search</a> and <a href="/docs/es/grouping-search.md">grouping search</a>.</p></li>
</ul>
