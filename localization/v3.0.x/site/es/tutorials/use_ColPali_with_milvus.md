...
<p>This page has been deprecated. For the latest example of the use of CoPali with Milvus, refer to <a href="/docs/es/search-with-embedding-lists.md">Sesarch with Embedding Lists</a>.</p>
</div>
<p>
