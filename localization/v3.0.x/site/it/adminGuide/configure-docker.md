  ...
  <tr>
    ...
    <td>
        <ul>
            ...
            <li><a href="/docs/it/configure_msgchannel.md">Message channel</a></li>
            ...
            <li><a href="/docs/it/configure_mq.md">Message Queue</a></li>
            <li><a href="/docs/it/configure_tikv.md">Tikv</a></li>
            <li><a href="/docs/it/configure_trace.md">Trace</a></li>
            <li><a href="/docs/it/configure_quotaandlimits.md">Quota and Limits</a></li>
        </ul>
    </td>
  </tr>
</tbody>
