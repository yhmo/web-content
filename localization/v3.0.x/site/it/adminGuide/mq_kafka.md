...
<button class="copy-code-btn"></button></code></pre>
<p>For SASL/SSL authentication details, see <a href="/docs/it/connect_kafka_ssl.md">Connect to Kafka with SASL/SSL</a>.</p>
...
<li>For SASL/SSL connectivity, see <a href="/docs/it/connect_kafka_ssl.md">Connect to Kafka with SASL/SSL</a>.</li>
</ul>
...
<li><a href="/docs/it/switch-kafka-woodpecker.md">Switch between Kafka and Woodpecker</a></li>
</ul>
