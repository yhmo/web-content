...
<ul>
<li><a href="/docs/it/eks.md">Deploy Milvus Cluster on AWS with Kubernetes</a></li>
<li><a href="/docs/it/azure.md">Deploy Milvus Cluster on Azure with Kubernetes</a></li>
