...
<li><p>GPU indexes do not support search functions like <a href="/docs/it/range-search.md">range search</a> and <a href="/docs/it/grouping-search.md">grouping search</a>.</p></li>
</ul>
