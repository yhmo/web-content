...
<p>For external collection configuration and usage instructions, see <a href="/docs/it/create-an-external-collection.md">Create an External Collection</a>.</p>
...
<tbody>
<tr><td>Vortex file format</td><td>Write new managed-collection data in the Vortex file format.</td><td><ul><li><a href="/docs/it/configure_common.md#commonstorageuseLoonFFI"><code translate="no">common.storage.useLoonFFI</code></a><code translate="no">=true</code></li><li><code translate="no">dataNode.storage.format=vortex</code></li></ul></td></tr>
<tr><td><a href="/docs/it/text.md"><code translate="no">TEXT</code> field</a></td><td>Store long source text, such as passages, documents, tickets, or logs, without setting a fixed maximum length in the collection schema.</td><td><a href="/docs/it/configure_common.md#commonstorageuseLoonFFI"><code translate="no">common.storage.useLoonFFI</code></a><code translate="no">=true</code></td></tr>
<tr><td><a href="/docs/it/add-fields-to-an-existing-collection.md">Function-generated vector fields</a></td><td>Add a BM25 or MinHash Function to an existing collection so Milvus generates a new vector field from an existing <code translate="no">VARCHAR</code> field. Milvus backfills the generated values for existing entities asynchronously through background compaction.</td><td><ul><li><a href="/docs/it/configure_common.md#commonstorageuseLoonFFI"><code translate="no">common.storage.useLoonFFI</code></a><code translate="no">=true</code></li><li><a href="/docs/it/configure_datacoord.md#dataCoordcompactionbumpSchemaVersionenabled"><code translate="no">dataCoord.compaction.bumpSchemaVersion.enabled</code></a><code translate="no">=true</code></li><li><a href="/docs/it/configure_datacoord.md#dataCoordcompactionstorageVersionenabled"><code translate="no">dataCoord.compaction.storageVersion.enabled</code></a><code translate="no">=true</code></li></ul></td></tr>
<tr><td><a href="/docs/it/create-an-external-collection.md">External collections</a></td><td>Query data stored outside Milvus without copying it into a managed collection. Refresh the external collection when the source data changes. To expose additional source fields, see <a href="/docs/it/alter-external-collection-schema.md">Alter External Collection Schema</a>.</td><td><a href="/docs/it/configure_common.md#commonstorageuseLoonFFI"><code translate="no">common.storage.useLoonFFI</code></a><code translate="no">=true</code></td></tr>
</tbody>
</table>
...
<li><a href="/docs/it/text.md">Text Field</a></li>
<li><a href="/docs/it/add-fields-to-an-existing-collection.md">Alter Collection Schema</a></li>
<li><a href="/docs/it/create-an-external-collection.md">Create an External Collection</a></li>
<li><a href="/docs/it/install-overview.md">Overview of Milvus Deployment Options</a></li>
<li><a href="/docs/it/upgrade_milvus_standalone-helm.md">Upgrade Milvus Standalone with Helm Chart</a></li>
<li><a href="/docs/it/upgrade_milvus_cluster-helm.md">Upgrade Milvus Cluster with Helm Chart</a></li>
<li><a href="/docs/it/configure_common.md">common-related Configurations</a></li>
<li><a href="/docs/it/configure_datacoord.md">dataCoord-related Configurations</a></li>
